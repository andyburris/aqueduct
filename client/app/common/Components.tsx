...
import { Button as AriaButton, FileTrigger, FileTriggerProps, ButtonProps } from "react-aria-components"
...
export const Link = withTailwindClasses<AllLinkProps, CustomButtonProps>(NextLink, customProps)